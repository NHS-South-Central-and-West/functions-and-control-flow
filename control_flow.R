...
# You can also use a switch statement - really useful for lots of conditions
...
# A loop will repeat a task until told to stop, a technique known as ITERATION
# There are two main types of loop - a FOR loop and a WHILE loop

# For loops work on a defined limit
# Like Python, R's for loop knows the length of an ITERABLE data structure
...
# This can be useful, like if you want to use more than one data structure
...
# BE CAREFUL! While powerful, they can be dangerous - make conditions specific!
a <- 0
while (a < 10) {
  print(a)
  a <-  a + 1
