...
# manyParams <- function(a, b, c, d, e, f, g){
...
# You can also declare variables within your function, but those are only usable inside the function
# This is call the SCOPE of the variable

# This is a GLOBAL variable - it will be available outside the function
# x <-  5

# localVarUse <- function(a, b){
